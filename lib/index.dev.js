...
var HotContainer = require('./HotContainer');
...
module.exports = function warnAboutIncorrectUsage(arg) {
  if (this && this.callback) {
    ...
    throw new Error('React Hot Loader does not have a default export. ' + 'If you use the import statement, make sure to include the ' + 'curly braces: import { HotContainer } from "react-hot-loader". ' + 'If you use CommonJS, make sure to read the named export: ' + 'require("react-hot-loader").HotContainer.');
  }
};
